                ...
                function i(a) {
                    return (
                        ...
                        ('left' !== R.parallaxDirection &&
                            ...
                            (x +=
                                j * Math.ceil(D * parseFloat(R.parallaxSpeed))),
                        ('up' !== R.parallaxDirection &&
                            'down' !== R.parallaxDirection) ||
                            (s +=
                                j * Math.ceil(v * parseFloat(R.parallaxSpeed))),
                        [x, s]
                    )
                }
                function r(a, e) {
                    switch (
                        ((w = parseInt(
                            a.css('padding-left').replace('px', '')
                        )),
                        (f = parseInt(
                            a.css('padding-right').replace('px', '')
                        )),
                        (u = parseInt(a.css('padding-top').replace('px', ''))),
                        (h = parseInt(
                            a.css('padding-bottom').replace('px', '')
                        )),
