...
!(function (t, i) {
    ...
    var W,
        H = {
            ...
            infinite: !(D.prototype = {
                ...
                toString: function (t) {
                    return (
                        'LatLng(' + r(this.lat, t) + ', ' + r(this.lng, t) + ')'
                    )
                },
                distanceTo: function (t) {
    ...
    Jt =
        'onselectstart' in document
            ...
            : ((Yt = fi([
              ...
              function () {
                  Yt &&
                      ((document.documentElement.style[Yt] = Kt), (Kt = void 0))
              })
    var Mi = {
        TRANSFORM: ti,
        TRANSITION: ii,
    ...
    var Ji = Xi.extend({
            ...
            addTo: function (t) {
                return (
                    Xi.prototype.addTo.call(this, t),
                        ...
                        : ((e = new k(
                          ...
                          (Math.abs(e.x) + Math.abs(e.y) <
                              ...
                              this._moved ||
                                  (this.fire('dragstart'),
                                  (this._moved = !0),
                                  (this._startPos = yi(this._element).subtract(
                                      e
                                  )),
        ...
        Ee = ie.extend({
            ...
            _adjustPan: function (t) {
                var i,
                    ...
                    h = n.getPixelOrigin(),
                    u = O(
                        a.min._subtract(h).add(s),
                        a.max._subtract(h).subtract(s)
                    )
                u.contains(r) ||
                    ((i = A(
    ...
    function De(t, i) {
        ...
        switch (r.type) {
            ...
            case 'MultiLineString':
                return (
                    (n = He(a, 'LineString' === r.type ? 0 : 1, l)),
                    new Oe(n, i)
                )
            case 'Polygon':
            case 'MultiPolygon':
                return (
                    (n = He(a, 'Polygon' === r.type ? 1 : 2, l)), new Re(n, i)
                )
        ...
        tn = Qe.extend({
            ...
            _adjustPan: function () {
                ...
                this.options.autoPan &&
                    ...
                    (t = this._map),
                    (i =
                        parseInt(oi(this._container, 'marginBottom'), 10) || 0),
                    (e = this._container.offsetHeight + i),
                    (n = this._containerWidth),
                    (o = new k(
                        this._containerLeft,
                        -e - this._containerBottom
                    ))._add(yi(this._container)),
    ...
    var en = Qe.extend({
        ...
        getEvents: function () {
            var t = Qe.prototype.getEvents.call(this)
            return (
                bt && !this.options.permanent && (t.preclick = this._close), t
            )
        },
        _close: function () {
